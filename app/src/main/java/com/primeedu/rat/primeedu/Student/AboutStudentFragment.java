...
//                        dialog.show();
    ...
    private void updateData() {
        ...
        final Student stD =  new Student(student.getSchoolcode(),student.getStudentcode(),CurrentStudentId,CurrentSection,
    ...
    public void checkEmpty(){
        ...
        if(student.getCurrentid().equals(CurrentStudentId) && student.getCurrentsection().equals(CurrentSection)
                && student.getCurrentclass().equals(Currentclass)){
            dialog.dismiss();
            updateData();
            ...
            classref.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if(dataSnapshot.getValue() ==null){
                        ...
                        if(dataSnapshot.getValue().toString().equals("")){
                            ...
                            dialog.dismiss();
                            openDialogBoxes("There already exists an user.Please contact with your class teacher.");
                        }
                    }
                }
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    openDialogBoxes("Something wrong.");
                }
            });
        }
    ...
    private void storeinCLass(final Student stD){

        final String Currentclass = spinner.getSelectedItem().toString();
        final String CurrentSection = sSec.getText().toString();
        final String CurrentStudentId = rollNo.getText().toString();
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        if(student.getCurrentid().equals(CurrentStudentId) && student.getCurrentsection().equals(CurrentSection)
                            ...
                            String path = "Classes/"+student.getSchoolcode()+"/class/"+student.getCurrentclass()+"/Section/"+student.getCurrentsection()+"/"+student.getCurrentid()+"/StudentCode/";
                            DatabaseReference ref = FirebaseDatabase.getInstance().getReference(path);
                            ref.setValue("");
                            student = stD;
                        }
