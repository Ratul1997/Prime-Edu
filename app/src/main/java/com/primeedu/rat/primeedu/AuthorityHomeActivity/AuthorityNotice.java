...
public class AuthorityNotice extends AppCompatActivity implements View.OnClickListener,SwipeRefreshLayout.OnRefreshListener{
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.getValue()== null){
                            ...
                            Toast.makeText(AuthorityNotice.this, "No Post Available.", Toast.LENGTH_SHORT).show();
