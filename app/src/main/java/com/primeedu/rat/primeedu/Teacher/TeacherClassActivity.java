...
import com.primeedu.rat.primeedu.AuthorityHomeActivity.AuthorityCreateClass;
...
public class TeacherClassActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String classUrl = "";
    Button add_class;
    List<Pair<String,List<String>>> listClassName = new ArrayList<>();
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot: dataSnapshot.getChildren()){
                    //0listClassName.add(snapshot.getKey());

                    List<String>ls = new ArrayList<>();
                    for(DataSnapshot snapshot1 :snapshot.getChildren()){
                        ls.add(snapshot1.getKey());
                    }
                    listClassName.add(new Pair<String, List<String>>(snapshot.getKey(),ls));
                }
                dialog.dismiss();
