...
public class TeacherClasses extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TeacherClasses(List<Pair<String,List<String>>> list, Context context, String schoolCode,String SchoolName,String TeacherId) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        v.txt.setText("Class: " +list.get(i).first);
        v.txt1.setText("");
        v.lin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context,TeacherAvailableSection.class);

                intent.putExtra("clsname",list.get(i).first);
                intent.putExtra("type","2");
                intent.putExtra("id",SchoolCode);
                intent.putExtra("schoolname",SchoolName);
                intent.putStringArrayListExtra("sections", (ArrayList<String>) list.get(i).second);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if(item.getItemId() == R.id.deletepost){
                            ...
                            String path = "Users/Teachers/"+TeacherId+"/Class/"+list.get(i).first+"/";
